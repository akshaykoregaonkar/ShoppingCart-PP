...
{
    class ShippingBasedDiscountTests
    {
        ...
        public void Init()
        {
            ...
            var discount1 = new Discount { DiscountType = DiscountType.ShippingBased, ProductCategory = ProductCategory.None, Supplier = Supplier.All, DiscountPercentage = 10 };
            var coupon1 = new Coupon { Id = 1, Code = "FREESHIPPING1", IsValid = true, Discount = discount1 };
            ...
            var coupon2 = new Coupon { Id = 2, Code = "FREESHIPPING2", IsValid = true, Discount = discount2 };
