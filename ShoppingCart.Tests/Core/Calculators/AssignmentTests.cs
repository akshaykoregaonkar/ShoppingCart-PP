...
namespace ShoppingCart.Tests.Core.Calculators
{
    public class AssignmentTests
    {
        ...
        public void Init()
        {
            ...
            var discount1 = new Discount { DiscountType = DiscountType.ProductBased, ProductCategory = ProductCategory.Audio, Supplier = Supplier.All, DiscountPercentage = 10 };
            var coupon1 = new Coupon { Id = 1, Code = "AUDIO10", IsValid = true, Discount = discount1 };
            var discount2 = new Discount { DiscountType = DiscountType.SupplierBased, ProductCategory = ProductCategory.None, Supplier = Supplier.Apple, DiscountPercentage = 5 };
            var coupon2 = new Coupon { Id = 2, Code = "APPLE5", IsValid = true, Discount = discount2 };
            var discount3 = new Discount { DiscountType = DiscountType.ShippingBased, ProductCategory = ProductCategory.Electronic, Supplier = Supplier.All };
            var coupon3 = new Coupon { Id = 3, Code = "FREESHIPPING", IsValid = true, Discount = discount3 };
        ...
        #region Assignment Test Cases
        [Test]
        public void WithFiveItems_CheckCalculationWithAudio10()
        {
            ...
            Assert.AreEqual(1122.00m, total);
        }

        [Test]
        public void WithFiveItems_CheckCalculationWithApple5()
        {
            var appleHeadphones = new CartItem(_productRepository) { ProductId = 1, UnitQuantity = 2 };
            var appleUsbCable = new CartItem(_productRepository) { ProductId = 2, UnitQuantity = 1 };
            var hPMonitor = new CartItem(_productRepository) { ProductId = 3, UnitQuantity = 1 };
            ...
            Assert.AreEqual(1122.80m, total);
        }

        [Test]
        public void WithFiveItems_CheckCalculationWithFreeShipping()
        {
            var appleHeadphones = new CartItem(_productRepository) { ProductId = 1, UnitQuantity = 2 };
            var appleUsbCable = new CartItem(_productRepository) { ProductId = 2, UnitQuantity = 1 };
            var hPMonitor = new CartItem(_productRepository) { ProductId = 3, UnitQuantity = 1 };
